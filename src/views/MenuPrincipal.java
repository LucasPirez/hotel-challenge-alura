...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Lucas D. Pirez Gallo © 2022");
		...
		btnLogin.setBounds(754, 210, 83, 70);
		...
		lblTitulo.setBounds(754, 180, 83, 24);
...
//		 superUsuario
		...
		btnCrearUsuario.setBounds(754, 350, 83, 70);
		btnCrearUsuario.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Login login = new Login("autenticarSuperUsuario");
				login.setVisible(true);
				dispose();
			}
		});
		...
		btnCrearUsuario.setBackground(SystemColor.window);
		panel.add(btnCrearUsuario);
		
		JLabel imagenCrearUsuario = new JLabel("");
		imagenCrearUsuario.setBounds(0, 0, 80, 70);
		btnCrearUsuario.add(imagenCrearUsuario);
		imagenCrearUsuario.setHorizontalAlignment(SwingConstants.CENTER);
		imagenCrearUsuario.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/login.png")));
		
		JLabel lblCrearUsuario = new JLabel("<html><body> <p>Crear </hr>Usuario</p></body></html>");
		lblCrearUsuario.setBounds(754, 300, 110, 44);
		lblCrearUsuario.setBackground(SystemColor.window);
		panel.add(lblCrearUsuario);
		lblCrearUsuario.setHorizontalAlignment(SwingConstants.CENTER);
		lblCrearUsuario.setForeground(SystemColor.textHighlight);
		lblCrearUsuario.setFont(new Font("Roboto Light", Font.PLAIN, 20));
	}
